...
COPY web web
ARG EOC_PUBLIC_MAP_TILE_URL="https://tile.openstreetmap.org/{z}/{x}/{y}.png"
ARG EOC_PUBLIC_RADAR_KIOSK_RESET_MINUTES="10"
ARG EOC_RELEASE_SHA="development"
ARG EOC_BUILD_ID="local"
RUN VITE_MAP_TILE_URL="$EOC_PUBLIC_MAP_TILE_URL" \
    VITE_RADAR_KIOSK_RESET_MINUTES="$EOC_PUBLIC_RADAR_KIOSK_RESET_MINUTES" \
